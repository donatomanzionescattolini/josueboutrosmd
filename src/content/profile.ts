...
export const tagline: Localized = {
  en: "Primary care built on continuity, plain language, and the patience to listen twice.",
  es: "Atención primaria basada en la continuidad, el lenguaje claro y la paciencia de escuchar dos veces.",
};

/** Two or three paragraphs. The home page shows the first; /about shows all. */
export const bio: Localized[] = [
  {
    en: "I am a family medicine resident physician in Hialeah, Florida, training at Palmetto General Hospital. Family medicine is the only specialty organized around a relationship rather than an organ system, and that is precisely why I chose it — I wanted to be the physician who is still there in ten years, who knows the whole household, and who can follow a question from a first well-child visit to a difficult conversation about a parent's last years.",
    es: "Soy médico residente de medicina familiar en Hialeah, Florida, formándome en Palmetto General Hospital. La medicina familiar es la única especialidad que se organiza alrededor de una relación y no de un órgano, y por eso precisamente la elegí: quería ser el médico que sigue presente diez años después, que conoce a toda la familia y que puede acompañar una historia desde la primera consulta de un niño sano hasta una conversación difícil sobre los últimos años de un padre.",
  },
  {
    en: "I trained in medicine at the Universidad de Ciencias Médicas de Camagüey in Cuba, where medicine is taught from the neighborhood inward — you learn the household before you learn the hospital. That grounding shapes how I practice now in South Florida, caring for a largely Spanish-speaking community where the difference between a plan that works and a plan that fails is often nothing more than whether it was explained in the language and the life the patient actually has.",
    es: "Estudié medicina en la Universidad de Ciencias Médicas de Camagüey, en Cuba, donde la medicina se enseña desde el barrio hacia adentro: uno aprende la casa antes de aprender el hospital. Esa formación define cómo ejerzo hoy en el sur de la Florida, atendiendo a una comunidad mayoritariamente hispanohablante donde la diferencia entre un plan que funciona y uno que fracasa suele ser, simplemente, si se explicó en el idioma y en la vida que el paciente realmente tiene.",
  },
  {
    en: "Most of my clinical attention goes where the numbers in this community go: diabetes, hypertension, obesity, and the long, unglamorous work of prevention. I am interested in the parts of that work that are usually treated as administrative — the follow-up call, the medication list that finally gets reconciled, the referral that actually closes — because those are the places where continuity is either kept or quietly lost.",
    es: "La mayor parte de mi atención clínica va hacia donde apuntan las cifras de esta comunidad: diabetes, hipertensión, obesidad y el trabajo largo y poco vistoso de la prevención. Me interesan especialmente las partes de ese trabajo que suelen tratarse como administrativas —la llamada de seguimiento, la lista de medicamentos que por fin se concilia, la referencia que de verdad se cierra— porque ahí es donde la continuidad se sostiene o se pierde en silencio.",
  },
];
